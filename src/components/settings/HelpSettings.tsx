      ...
      <div className="max-w-3xl mx-auto space-y-5">
        ...
        <section className="rounded-2xl border border-border-subtle bg-bg-card p-5 space-y-4">
          ...
          <Step n={2} title="Add your Deepgram key">
            Create a Deepgram API key, paste it in AI Providers, save it, then run the 3-second transcription test. Deepgram Flux is the default cloud transcription path for the friend-ready build.
            <div className="flex flex-wrap gap-2 mt-3">
              <button
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Card title="Windows Packaging" icon={<PackageCheck size={16} />}>
            <p>The recommended sharing format is the portable Windows EXE generated by:</p>
            <pre className="rounded-lg bg-bg-input border border-border-subtle p-3 text-[11px] text-text-primary overflow-x-auto">npm run dist:win</pre>
            <p>Unsigned builds may show SmartScreen. Click More info, then Run anyway.</p>
          </Card>

          <Card title="Audio Permissions" icon={<Mic size={16} />}>
            <p>Make sure Windows allows microphone access and that system audio is playing through the selected output device.</p>
        ...
        <div className="rounded-2xl border border-border-subtle bg-bg-card p-4 flex items-start gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-text-primary">Friend install prompt</h3>
            <p className="text-xs text-text-secondary mt-1 leading-relaxed">
              Tell Claude: "Install Natively OSS from this GitHub repo. Use the latest Windows portable EXE from Releases if available. After launch, help me add my OpenRouter and Deepgram keys in Settings &gt; AI Providers."
            </p>
          </div>
        </div>
      </div>
