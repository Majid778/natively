...
export class AppState {
  ...
  private setupAutoUpdater(): void {
    ...
    // Channel stays 'latest' to match the latest.yml / latest-mac.yml generated by
    // electron-builder. Beta releases are published as GitHub *prereleases*; without
    // allowPrerelease, electron-updater queries /releases/latest (stable only) and
    // reports "No published versions on GitHub", so updates never appear.
    autoUpdater.channel = 'latest'
    autoUpdater.allowPrerelease = true
    console.log(`[AutoUpdater] Channel: ${autoUpdater.channel}, allowPrerelease: ${autoUpdater.allowPrerelease}`)
